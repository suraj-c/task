...
import { ANZ104AngularDemoCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'ANZ104AngularDemo',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for ANZ104AngularDemo'
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        ANZ104AngularDemoCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
